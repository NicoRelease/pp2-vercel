                ...
                <div style={styles.taskContainer}>
                  ...
                  {sesion.tareas && sesion.tareas.length > 0 ? (
                    sesion.tareas.map((tarea) => {
                      ...
                      const esTareaVencida = tarea.fecha_programada < hoy1 && !tarea.es_completada;
                      ...
                      return (
                        <div 
                          ...
                          style={{
                            ...styles.taskItem,
                            backgroundColor: tarea.es_completada ? '#f8fff8' : (esTareaVencida ? '#f9f9f9' : '#fff'),
                            opacity: esTareaVencida ? 0.7 : 1,
                            cursor: esTareaVencida ? 'not-allowed' : 'pointer',
                            borderLeft: tarea.es_completada ? '4px solid #28a745' : (esTareaVencida ? '4px solid #6c757d' : '4px solid #ffc107')
                          }}
                          onClick={() => {
                            if (esTareaVencida && !tarea.es_completada) {
                              alert("No puedes editar una tarea vencida. Solo se permite marcarla como completada.");
                              return;
                            }
                        ...
                        >
                          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                            <span>{tarea.es_completada ? '✅' : (esTareaVencida ? '⏰' : '📝')}</span>
